  ...
  return (
    <>
      <style>{`
        ...
        .note-editor .editor-code-block {
          background: #0b0f19; border: 1px solid rgba(148,163,184,0.26);
        ...
        .note-editor .editor-code-header {
          min-height: 40px; display: flex; align-items: center; padding: 0 14px;
          border-bottom: 1px solid rgba(148,163,184,0.22);
        }
        .note-editor .editor-code-language-select {
          height: 28px; min-width: 132px; border: none; border-radius: 6px;
          background: rgba(255,255,255,0.045); color: rgba(226,232,240,0.86);
          font-family: 'Syne', sans-serif; font-size: 11px; font-weight: 600;
          letter-spacing: 0.04em; text-transform: uppercase; padding: 0 26px 0 9px;
        ...
        .note-editor pre code {
          ...
          color: rgba(226,232,240,0.9); font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;
